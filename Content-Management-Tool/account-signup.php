    ...
    <div id="signUpContainer" class="container">
      ...
      <div id="signUpForm" class="containerForm">
        ...
        <div class="btnContainer">
          <button type="submit" id="signUp" class="submitBtn"><a href="email-verify.php">Proceed</a></button>
          <button type="submit" id="loginAccSlideBtn" class="nextBtn"><a href="account-login.php">Have an account?</a></button>
        </div>
      </div>
    </div>
  </div>
